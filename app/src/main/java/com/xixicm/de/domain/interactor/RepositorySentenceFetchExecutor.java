 ...
 * @author mc
 */
public class RepositorySentenceFetchExecutor implements SentenceFetchExecutor {
    SentenceRepository mSentenceRepository;

    public RepositorySentenceFetchExecutor(SentenceRepository sentenceRepository) {
        mSentenceRepository = sentenceRepository;
    }

    @Override
    public void fetchTodaysSentence(boolean manual) {
        mSentenceRepository.fetchTodaysSentence(manual);
    }
}
